...
//        }
        ...
        System.out.println("For løkke starter");
        for(int i = 0; i < s16.size(); i++){
            System.out.println("For løkke i gang");
            shipPlacement[9+i][3] = "X";
        }
        System.out.println("For løkke slut");

        Position pos17 = new Position(2, 8);
        Ship s17 = fleet.getShip(3);
        board.placeShip(pos17, s17, true);
        for(int i = 0; i < s17.size(); i++){
            shipPlacement[2+i][8] = "X";
        }
